...
public class PlatformAndroidApi {
	...
	public static String channelex = "";	//渠道额外信息
...
//		 FirebaseMessaging.getInstance().subscribeToTopic();
	...
	public static String getChannelExStr(){ return channelex;}
...
//		}
	...
	public static String getSimacardid(){
		return String.valueOf(ProjUtil.getSimcardid());
	}
...
//		Log.d("===IMSI:",String.valueOf(ProjUtil.getIMSI()));
//		return String.valueOf(ProjUtil.getIMSI());
//	}

	//请求通讯录
	public static void requestContracts(){
		AppActivity.getConstract();
	}
	...
	public static void sendMail(String data){
		...
		try {
			...
			if(sendWay == "send"){
				...
				email= new Intent(android.content.Intent.ACTION_SENDTO);
...
//					email.setData(Uri.parse("mailto:"+sender));
